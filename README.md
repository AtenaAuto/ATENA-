...
| `./atena digital-organism-live-cycle` | Aprende na internet, cria software, executa e testa automaticamente | `./atena digital-organism-live-cycle --topic "autonomous ai engineering"` |
