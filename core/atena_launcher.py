...
def render_help() -> None:
   ...
   ╚═╝  ╚═╝   ╚═╝   ╚══════╝╚═╝  ╚═══╝╚═╝  ╚═╝
    ...
    try:
        ...
        table.add_row("./atena hacker-recon --topic <tópico>", "Hacker Recon avançado (batch/JSON/score/histórico/timeout)")
        ...
        print("  ./atena hacker-recon --topic <tópico>|--batch-file arq [...flags...] [--history-json arq] [--prioritize-history]")
