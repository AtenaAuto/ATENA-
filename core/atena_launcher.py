...
def render_help() -> None:
   ...
   ╚═╝  ╚═╝   ╚═╝   ╚══════╝╚═╝  ╚═══╝╚═╝  ╚═╝
    ...
    try:
        ...
        table.add_row("./atena hacker-recon --topic <tópico>", "Executa Hacker Recon avançado (JSON + relatório)")
        ...
        print("  ./atena hacker-recon --topic <tópico> [--auto] [--cycles N] [--json] # Hacker Recon avançado")
