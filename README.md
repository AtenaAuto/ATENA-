...
| `./atena hacker-recon --topic <tópico>` | Executa Hacker Recon avançado (suporta `--auto`, `--cycles`, `--json`, relatório automático) | `./atena hacker-recon --topic "zero-day ai agents" --auto --cycles 3 --json` |
